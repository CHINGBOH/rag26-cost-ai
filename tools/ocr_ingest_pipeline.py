...
XINXI_FILES = [
    ...
    ('2023-11', OCR_DIR/'2023-11_merged_ocr.json',      '2023-11.pdf'),
    ('2023-12', OCR_DIR/'2023-12_ocr.json',             '2023-12.pdf'),
    ('2024-12', OCR_DIR/'2024-12_merged_ocr.json',      '2024-12.pdf'),
    ('2025-01', OCR_DIR/'2025-01_ocr.json',             '2025-01.pdf'),
    ('2025-02', OCR_DIR/'2025-02_ocr.json',             '2025-02.pdf'),
    ('2025-04', OCR_DIR/'2025-04_ocr.json',             '2025-04.pdf'),
    ('2025-05', OCR_DIR/'2025-05_ocr.json',             '2025-05.pdf'),
    ('2025-07', OCR_DIR/'2025-07_ocr.json',             '2025-07.pdf'),
    ('2025-08', OCR_DIR/'2025-08_ocr.json',             '2025-08.pdf'),
    ('2025-10', OCR_DIR/'2025-10_ocr.json',             '2025-10.pdf'),
    ('2025-11', OCR_DIR/'2025-11_ocr.json',             '2025-11.pdf'),
    ('2025-12', OCR_DIR/'2025-12_ocr.json',             '2025-12.pdf'),
    ('2026-01', OCR_DIR/'《深圳建设工程价格信息》2026年1月_ocr.json',
                '《深圳建设工程价格信息》2026年1月.pdf'),
    ('2026-02', OCR_DIR/'《深圳建设工程价格信息》2026年2月_ocr.json',
                '《深圳建设工程价格信息》2026年2月.pdf'),
]
